...
WIDGET_TEMPLATE
        )); ?> <aside data-id="d2e6" class="u-sidebar u-indent-40" style="flex-basis: auto; width: 250px;"><?php if ($sidebar_html) { echo stylingDefaultControls($sidebar_html); } else { ?> <div class="u-block u-indent-30">
        <div class="u-block-container u-clearfix">
